...
from coda_scheduler_EPF import CODAScheduler
...
# Final O2I exploration-pressure settings.
...
def _save_metadata(
    ...
    *,
    ...
    payload = {
        ...
        "max_gp_points": 1000,
        "o2i_feedback": {
            "method": "ucb_exploration_pressure_ratio",
            "mean_model": "observation_based_gp",
            "variance_model": "pb2_batch_adjusted_gp",
            "formula": "bonus/(abs(mean)+bonus+epsilon)",
