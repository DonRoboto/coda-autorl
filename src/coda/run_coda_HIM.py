...
from coda_scheduler_HIM import CODAScheduler
...
RUN_TAG = os.environ.get("CODA_RUN_TAG", "HIM").strip()
...
# Hyperparameter Intervention Magnitude (HIM) O2I settings.
...
class CODACallback(DefaultCallbacks):
    ...
    def on_train_result(self, *, algorithm, result: dict, **kwargs):
        ...
        custom["coda_o2i_delta_entropy_coeff"] = self._safe_float(
            bridge.get("o2i_delta_entropy_coeff", 0.0), 0.0
        )
        custom["coda_o2i_delta_lr"] = self._safe_float(
            bridge.get("o2i_delta_lr", 0.0), 0.0
        )
        custom["coda_o2i_delta_vf_loss_coeff"] = self._safe_float(
            bridge.get("o2i_delta_vf_loss_coeff", 0.0), 0.0
        )
    ...
    payload = {
        ...
        "o2i_feedback": {
            ...
            "proposal_configuration":
                "nominal_pb2_proposal_before_o2i_entropy_increment",
...
def _extract_metrics(
    ...
    columns_wanted = [
        ...
        "custom_metrics/coda_o2i_delta_entropy_coeff",
        "custom_metrics/coda_o2i_delta_lr",
        "custom_metrics/coda_o2i_delta_vf_loss_coeff",
