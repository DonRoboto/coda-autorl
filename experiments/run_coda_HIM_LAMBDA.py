...
from coda_scheduler_HIM_LAMBDA import CODAScheduler
...
RUN_TAG = os.environ.get("CODA_RUN_TAG", "HIM_LAMBDA").strip()
...
HYPERPARAM_BOUNDS = {
    ...
    # the legacy Tune key as `lambda`. The scheduler therefore optimizes
    ...
    *,
    ...
    payload = {
        ...
        "optimized_hyperparameters": [
            "train_batch_size", "lambda", "lr", "vf_loss_coeff"
        ],
        ...
        "o2i_feedback": {
            ...
            "proposal_configuration":
                "nominal_pb2_proposal_over_batch_lambda_lr_vf",
